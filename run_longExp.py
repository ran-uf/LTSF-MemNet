...
parser = argparse.ArgumentParser(description='Implement of MemNet for Time Series Forecasting')
...
parser.add_argument('--value_features', type=int, default=32, help='num of heads')
parser.add_argument('--memory_size', type=int, default=8, help='dimension of model')
parser.add_argument('--sigma', type=int, default=2, help='num of heads')
# DLinear
...
if args.model == "MemNet" or args.model == "KernelLayer":
    args.batch_size = 256
    args.label_len = 0
